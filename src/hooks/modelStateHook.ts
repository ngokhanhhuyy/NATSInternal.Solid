...
export function createModelState(options?: ModelStateOptions): IModelState {
    ...
    return {
        ...
        hasError(propertyPath: string): boolean {
            ...
            try {
                return getErrorsState()[propertyPath as keyof IModelStateErrors][0] != null;
            } catch {
                return false;
            }
        },
        ...
        getError(propertyPath: string): string | null {
            ...
            try {
                return getErrorsState()[propertyPath][0] || null;
            } catch {
                return null;
            }
        },
        ...
        getAllErrorMessages(): string[] {
            ...
            for (const propertyErrors of Object.values(getErrorsState())) {
        ...
        hasAnyError(): boolean {
            return getErrorsState() != null && Object.keys(getErrorsState()).length > 0;
        },
